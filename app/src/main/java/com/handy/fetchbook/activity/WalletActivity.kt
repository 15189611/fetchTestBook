...
import com.handy.fetchbook.databinding.MeActivityWalletBinding
...
class WalletActivity : BaseActivity<HomeViewModel, MeActivityWalletBinding>() {
    override fun layoutId() = R.layout.me_activity_wallet
