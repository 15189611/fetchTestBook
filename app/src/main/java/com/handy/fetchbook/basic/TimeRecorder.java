...
class TimeRecorder {
     ...
     */
    static final String TIME_RECORDER_LOG = "TimeRecorder";
    /**
     ...
     */
    static void beginNanoCount(@NonNull String tag) {
        if (!ENABLED) {
            return;
        }
     ...
     * ->  {@link #endNanoCount(String, String)} 输出总耗时情况
     */
    static void pauseNanoCount(@NonNull String tag) {
        if (!ENABLED) {
            return;
        }
        ensureNanoCountTimeMap();
     ...
     */
    static void endNanoCount(@NonNull String tag) {
     ...
     * ->  {@link #endNanoCount(String, String)} 输出总耗时情况
     */
    static void endNanoCount(@NonNull String tag, @Nullable String call) {
        if (!ENABLED) {
            return;
        }
        ensureNanoCountTimeMap();
    ...
    static String nanoToMillis(long nanoTime) {
     ...
     * @param tag : 记录时间的惟一标识
     */
    static void begin(@NonNull String tag) {
        if (ENABLED) {
            ensureTimeMap();
     ...
     * {@link #begin(String)}
     */
    static void end(@NonNull String tag) {
        end(tag, null);
    }
     ...
     */
    static void end(@NonNull String tag, @Nullable String call) {
        if (ENABLED) {
            ensureTimeMap();
