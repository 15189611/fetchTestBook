package com.handy.p11app.me.widget
...
import com.handy.fetchbook.net.Configuration.token
import com.handy.fetchbook.utils.AESUtil
import com.handy.fetchbook.utils.ImageUtil
import com.handy.fetchbook.view.WordImageView
    ...
    private fun loadCaptcha() {
        ...
        GlobalScope.launch(Dispatchers.Main) {
            try {
                ...
                val b = Configuration.server.getWordCaptchaAsync().await().body()
                when (b?.code) {
                    ...
                    0 -> {
                        ...
                        var wordStr: String = ""
                        var i = 0;
                        b.data!!.wordList!!.forEach {
                            i++
                            wordStr += it
                            if (i < b.data!!.wordList!!.size)
                                wordStr += ","
                        }
                        wordView.setSize(b.data!!.wordList!!.size)
